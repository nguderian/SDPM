...
exports.getUserProfile = function (access_token, callback, user_id) {
  request(canvas_link +'users/' + user_id + '/profile?access_token=' + access_token, { json: true }, (err, res, body) => {
    if (err) { return console.log(err); }
    return callback(body);
  })
};
exports.getCoursesofUser = function (access_token, callback, user_id) {
...
exports.getStudentsinCourse = function (access_token, callback, course_id){
...
exports.getGroupsinCourse = function (access_token, callback, course_id) {
...
exports.getUsersinGroup = function (access_token, callback, group_id) {
